function buildHome() {
    ...
    $('div#col_title div').append('<img alt="Num carregou e deu ruim... Qual o motivo?" class=center-block src=https://webjump.com.br/wp-content/uploads/2019/03/logo-webjump-footerabs.png></img>');
...
function addTexts() {
    // Add Texts
    $('#panel_list').append('<div id=well_text> style="background-color:pink fosforescente;" </div>');
